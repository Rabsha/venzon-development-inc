...
<head>
    ...
    <link href="assets/css/style.css?v=<?= filemtime('style.css'); ?>" rel="stylesheet">
</head>
<body class="bg-dark text-gray-100 antialiased selection:bg-gold-600 selection:text-white">

    <audio id="ambientAudio" src="assets/images/websound.mp3" loop autoplay muted preload="auto" playsinline>
    ...
    <script>
        ...
        window.ambientAudio.muted = true;
    ...
    <div id="loader" class="fixed inset-0 z-[100] bg-dark flex flex-col items-center justify-center p-6 loader-overlay">
        ...
        <div
            class="absolute inset-0 bg-center bg-cover bg-no-repeat opacity-30"
            style="background-image: url('assets/images/loaderbg.jpg');">
        </div>
        ...
        <div class="text-center max-w-lg z-10 loader-content-delayed">
            ...
            <p class="text-gray-400 text-sm md:text-base font-light leading-relaxed tracking-wide">
                Creating Generational Wealth Thru Real Estate
            </p>
            <div class="mt-5 text-[10px] md:text-xs font-semibold tracking-[0.45em] text-gold-500/90">
                Loading <span id="loaderProgressNumber">00</span><span>%</span>
            </div>
        </div>
    </div>
    ...
    <section id="hero" class="relative w-full h-screen overflow-hidden flex items-center justify-center">
        ...
        <div class="relative z-20 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
            ...
            <p class="text-gray-300 text-base md:text-xl font-light max-w-2xl leading-relaxed tracking-wide mb-10 text-center">
                Developing, and operating world-class residential, and premium luxury resorts across globe.
            </p>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                ...
                <div class="lg:col-span-7 flex flex-col justify-center" data-aos="fade-left">
                    <span class="text-gold-500 uppercase tracking-[0.4em] text-xs font-bold mb-4 block">Adding Value</span>
                    <h2 class="font-serif text-4xl md:text-6xl font-light text-white leading-tight mb-8">
                        Creating Value Thru Real Estate Development.
                    </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-white/10">
                        <div>
                            ...
                            <p class="text-gray-400 text-xs font-light leading-relaxed">Luxury resorts strategically located near pristine oceans and majestic deserts or city centers.</p>
                        </div>
                        <div>
                            <h4 class="text-white font-semibold text-sm uppercase tracking-wider mb-2 flex items-center gap-2">
                                <i class="fa-solid fa-city text-gold-500"></i> Residential Communities
                            </h4>
                            <p class="text-gray-400 text-xs font-light leading-relaxed">Premium apartment complexes with modern amenities.</p>
                        </div>
                    </div>
                </div>
    ...
    <section id="projects" class="py-24 md:py-36 bg-charcoal relative">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-wrap gap-3 mb-12 border-b border-white/10 pb-6" data-aos="fade-up">
                ...
                <button class="gallery-tab px-6 py-2.5 text-xs uppercase tracking-widest font-semibold text-gray-400 hover:text-white border border-white/10 hover:border-white/30 transition-all duration-300">
                    Residential
                </button>
                <button class="gallery-tab px-6 py-2.5 text-xs uppercase tracking-widest font-semibold text-gray-400 hover:text-white border border-white/10 hover:border-white/30 transition-all duration-300">
                    Hospitality
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="galleryContainer">
                ...
                <div class="gallery-item housing group relative overflow-hidden bg-dark aspect-[4/5]" data-aos="fade-up">
                    ...
                    <img src="assets/images/apartment.jpeg" class="absolute inset-0 w-full h-full object-cover zoom-bg" alt="Lumina Towers Residential">
                ...
                <div class="gallery-item hospitality group relative overflow-hidden bg-dark aspect-[4/5]" data-aos="fade-up" data-aos-delay="100">
                    <div class="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent z-10 transition-opacity duration-300"></div>
                    <img src="assets/images/townhomes.jpeg" class="absolute inset-0 w-full h-full object-cover zoom-bg" alt="Oasis Sands Desert Resort">
                    <div class="absolute bottom-0 left-0 right-0 p-8 z-20">
                ...
                <div class="gallery-item commercial group relative overflow-hidden bg-dark aspect-[4/5]" data-aos="fade-up" data-aos-delay="200">
                    <div class="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent z-10 transition-opacity duration-300"></div>
                    <img src="assets/images/hospitality.jpeg" class="absolute inset-0 w-full h-full object-cover zoom-bg" alt="Venzon One Corporate Hub">
                    <div class="absolute bottom-0 left-0 right-0 p-8 z-20">
    ...
    <section id="strategy" class="py-24 md:py-36 bg-dark relative overflow-hidden">
        ...
        <div class="max-w-[96rem] mx-auto px-6 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-20" data-aos="fade-up">
                ...
                <p class="text-gray-400 text-sm md:text-base font-light mt-6 leading-relaxed">
                    A rigorous five-stage approach designed to mitigate execution risk while unlocking unparalleled return for private family offices and private investors.
                </p>
                <p class="text-gray-400 text-sm md:text-base font-light mt-6 leading-relaxed">
                    VENZON Development inc. is a real estate
                    development and investment company. We
                    believe that building real estate assets from
                    the ground up adds significant value
                    through the integration of modern design
                    and advanced technology. Because our
                    properties are new constructions, they
                    benefit from considerably lower
                    maintenance costs and deliver higher rental
                    yields.
                </p>
            </div>
            ...
            <div class="space-y-10">
                ...
                <!-- DEVELOPMENT -->
                <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_1.5rem_minmax(0,1fr)_1.5rem_minmax(0,1fr)_1.5rem_minmax(0,1fr)_1.5rem_minmax(0,1fr)] gap-3 xl:gap-5 items-stretch">
                    <div class="group bg-charcoal p-5 xl:p-6 border border-white/5 hover:border-gold-500/40 transition-all duration-300">
    ...
    <section id="model" class="py-24 md:py-36 bg-charcoal relative">
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-20" data-aos="fade-up">
                ...
                <p class="text-gray-400 text-sm md:text-base font-light mt-6 leading-relaxed">
                    We use GP/LP Model where venzon acts as general partner & equity investors as limited partners. Property title is head in LP Name & Venzon signs a Development contract with LP.
                </p>
            </div>

            <h3 class="font-serif text-3xl md:text-5xl font-light text-white text-center mb-12">Build • Rent • Sell</h3>

            <div class="space-y-10">

                <!-- DEVELOPMENT -->
                <div class="investment-model-flow grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_1.5rem_minmax(0,1fr)_1.5rem_minmax(0,1fr)] gap-6 items-stretch">
                    ...
                    <div class="group bg-charcoal p-8 border border-white/5 hover:border-gold-500/40 transition-all duration-300">
                        ...
                        <p class="text-gray-400 text-xs font-light leading-relaxed">
                            VENZON structures each project with a balanced mix of capital. Private investors (Limited Partners) contribute up to 50% of the development cost as equity. Institutional debt finances the remaining 50%. VENZON participates as a Limited Partner by investing up to 20% of the equity portion.
                        </p>
                    </div>
                    ...
                    <div class="group bg-charcoal p-8 border border-white/5 hover:border-gold-500/40 transition-all duration-300">
                        <span class="font-serif text-5xl text-gold-500/30">02</span>
                        <h3 class="text-white text-lg font-semibold uppercase mt-4">
                            Form Limited Partnership (LP)
                        </h3>
                        <p class="text-gray-400 text-xs font-light leading-relaxed">
                            A Limited Partnership is formed to own the project. The property title is held directly in the name of the LP, providing clear ownership and legal structure for all investors.
                        </p>
                    </div>
                    ...
                    <div class="group bg-charcoal p-8 border border-white/5 hover:border-gold-500/40 transition-all duration-300">
                        ...
                        <p class="text-gray-400 text-xs font-light leading-relaxed">
                            The Limited Partnership signs a comprehensive Development and Management Agreement with VENZON as the General Partner. This agreement outlines VENZON’s responsibilities for executing the full project cycle.
                        </p>
                    </div>
                    ...
                    <div class="group bg-charcoal p-8 border border-white/5 hover:border-gold-500/40 transition-all duration-300">
                        ...
                        <p class="text-gray-400 text-xs font-light leading-relaxed">
                            VENZON manages the entire operational phase, including property development, ongoing maintenance, and rental operations to generate stable income throughout the holding period.
                        </p>
                    </div>
                    ...
                    <div class="group bg-charcoal p-8 border border-white/5 hover:border-gold-500/40 transition-all duration-300">
                        ...
                        <p class="text-gray-400 text-xs font-light leading-relaxed">
                            Once predefined performance hurdles are met, VENZON executes the strategic sale of the asset on behalf of the Limited Partnership to maximize value and returns.
                        </p>
                    </div>
                    ...
                    <div class="group bg-charcoal p-8 border border-white/5 hover:border-gold-500/40 transition-all duration-300">
                        <span class="font-serif text-5xl text-gold-500/30">06</span>
                        <h3 class="text-white text-lg font-semibold uppercase mt-4">
                            Returns Distribution
                        </h3>
                        <p class="text-gray-400 text-xs font-light leading-relaxed">
                            Profits and proceeds are distributed according to the agreement. Limited Partners first receive their preferred return. VENZON then earns development and management fees plus a share of the remaining profits.
                        </p>
                    </div>
    ...
    <section id="mission" class="relative py-24 md:py-36 bg-dark overflow-hidden text-center flex items-center justify-center">
        ...
        <div class="relative z-20 max-w-4xl mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-8 text-center pt-8 border-t border-white/10" data-aos="fade-up" data-aos-delay="400">
                <div>
                    <span class="font-serif text-3xl md:text-4xl text-gold-400">18%</span>
                    <span class="text-[10px] uppercase tracking-wider text-gray-400 mt-2 block">Target IRR</span>
                </div>
                <div>
                    <span class="font-serif text-3xl md:text-4xl text-gold-400">2x</span>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div data-aos="fade-right">
                    ...
                    <h2 class="font-serif text-4xl md:text-6xl font-light text-white mb-6">Coordinate With Our Team</h2>
                    <div class="w-20 h-[1px] bg-gold-500 mb-8"></div>
                    ...
                    <!-- Social coordinates -->
                    <div>
                        <h4 class="text-xs uppercase tracking-widest text-gold-500 font-bold mb-4">Investor Disclaimer</h4>
                        <p class="text-gray-400 text-sm md:text-sm font-light leading-relaxed max-w-lg">
                            The Information contained in this website is for informational purposes only and does not constitute an offer to sell or a solicitation of an offer to buy any securities. Any investment in VENZON projects will be made solely through private placement memoranda and subscription documents.
                            Investments in real estate projects involve substantial risks, including the potential loss of all or a portion of the invested capital. Past performance is not indicative of future results. There is no guarantee of returns, rental income, or profit.
                            This communication is directed only to accredited investors as defined under Rule 501 of Regulation D of the U.S. Securities Act of 1933, as amended. The securities have not been registered with the U.S. Securities and Exchange Commission (SEC) or any state securities commission and are being offered in reliance upon exemptions from registration.
                            Prospective investors should carefully review all offering documents and consult with their own legal, tax, and financial advisors before making any investment decision. VENZON Development Inc. makes no representations or warranties regarding the accuracy or completeness of the information provided.
                        </p>
    ...
    <footer class="bg-black py-16 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
                <p>&copy; <?=  date('Y'); ?> VENZON Development Inc. All rights reserved.</p>
    ...
    <script>
        ...
        function startLoaderProgress() {
            const loaderProgressNumber = document.getElementById('loaderProgressNumber');
            if (!loaderProgressNumber) return;

            const progressDuration = mainPageDelay;
            const progressStartTime = Date.now() + loaderIntroDelay;
            const progressTimer = setInterval(() => {
                const elapsed = Math.max(0, Date.now() - progressStartTime);
                const progress = Math.min(100, Math.round((elapsed / progressDuration) * 100));

                loaderProgressNumber.textContent = String(progress).padStart(2, '0');
        ...
        function unlockAmbientAudio(event) {
            if (event.target && event.target.closest && event.target.closest('#audioStatusContainer')) return;

            playAmbientAudio().then(() => {
                if (audioPlaying) {
                    removeAudioUnlockEvents();
                }
            });
        }

        const audioUnlockOptions = { passive: true, capture: true };

        function addAudioUnlockEvents() {
            document.addEventListener('pointerdown', unlockAmbientAudio, audioUnlockOptions);
            document.addEventListener('keydown', unlockAmbientAudio, audioUnlockOptions);
            document.addEventListener('keypress', unlockAmbientAudio, audioUnlockOptions);
            document.addEventListener('touchstart', unlockAmbientAudio, audioUnlockOptions);
            document.addEventListener('touchmove', unlockAmbientAudio, audioUnlockOptions);
            document.addEventListener('wheel', unlockAmbientAudio, audioUnlockOptions);
            document.addEventListener('mousewheel', unlockAmbientAudio, audioUnlockOptions);
            window.addEventListener('scroll', unlockAmbientAudio, audioUnlockOptions);
        }

        function removeAudioUnlockEvents() {
            document.removeEventListener('pointerdown', unlockAmbientAudio, audioUnlockOptions);
            document.removeEventListener('keydown', unlockAmbientAudio, audioUnlockOptions);
            document.removeEventListener('keypress', unlockAmbientAudio, audioUnlockOptions);
            document.removeEventListener('touchstart', unlockAmbientAudio, audioUnlockOptions);
            document.removeEventListener('touchmove', unlockAmbientAudio, audioUnlockOptions);
            document.removeEventListener('wheel', unlockAmbientAudio, audioUnlockOptions);
            document.removeEventListener('mousewheel', unlockAmbientAudio, audioUnlockOptions);
            window.removeEventListener('scroll', unlockAmbientAudio, audioUnlockOptions);
        }

        addAudioUnlockEvents();
